...
if(isset($_POST["checkout"])){
	...
	$q3 = mysqli_query($conn, "update cart2 set status='Payment' where orderid='$orderidd'");
	if($q3){
...
<div class="checkout">
		<div class="container">
			<h1>Terima kasih, <?=$_SESSION['uname']?> telah membeli <?php echo $itungtrans3 ?> barang di Pet Shop</span></h1>
			<div class="checkout-right">
				<table class="timetable_sub">
					...
					<tr class="rem1"><form method="post">
						...
						<td class="invert"><a href="produk.php?id=<?php echo $b['idbrg'] ?>"><img src="<?php echo $b['gambar_brg'] ?>" width="100px" height="100px" /></a></td>
						...
						<td class="invert">Rp<?php echo number_format($b['harga_brg']*$b['qty']) ?></td>
						<td class="invert">
							<div class="rem">
        ...
        <h4><?php echo $p['metode'] ?> - <?php echo $p['rekening'] ?><br>

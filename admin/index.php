<?php 
	...
	$itungcust = mysqli_query($conn,"select count(id) as jumlahcust from user where role='member'");
	$itungcust2 = mysqli_fetch_assoc($itungcust);
	$itungcust3 = $itungcust2['jumlahcust'];
	
	$itungorder = mysqli_query($conn,"select count(idcart) as jumlahorder from cart2 where status not like 'Selesai' and status not like 'Canceled'");
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="market-status-table mt-4">
                                    Anda masuk sebagai <strong><?php echo $_SESSION['uname'] ?></strong>
									<br>

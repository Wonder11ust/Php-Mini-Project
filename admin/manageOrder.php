...
<head>
    ...
    <title>Kelola Pesanan - Pet Shop</title>
                                ...
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    ...
                                    <div class="data-tables datatable-dark">
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											<?php 
											$brgs=mysqli_query($conn,"SELECT * from cart2 c, user l where c.iduser=l.id and status!='cart' and status!='Selesai' order by idcart ASC");
											$no=1;
											...
											$orderids = $p['orderid'];
												...
												$result1 = mysqli_query($conn,"SELECT SUM(d.qty*p.harga_brg) AS count FROM detailorder d, produk p where orderid='$orderids' and p.idbrg=d.id_brg order by d.id_brg ASC");
